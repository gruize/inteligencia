...
/**
 * 
 * Clase que muestra la interfaz del formulario de ayuda.
 * 
 * @author Kenzitron
 *
 */
...
public class IAICbuenoAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(GUI.IAICbuenoApp.class).getContext().getResourceMap(IAICbuenoAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(GUI.IAICbuenoApp.class).getContext().getActionMap(IAICbuenoAboutBox.class, this);
