...
public class Reinas implements Juego{
    ...
    protected Search busqueda = null;
    protected SearchAgent agente = null;
    protected Problem problema = null;
    ...
    public Reinas() {
        ...
        this.problema = new Problem(this.estado,new FuncionSucesor(),(GoalTest) this.objetivo, new FuncionHeuristica());
    }
